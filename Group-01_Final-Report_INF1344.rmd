...
hdi <- clean_names(hdi) 
head(colnames(hdi), 5)
tail(colnames(hdi), 5) #comment here
```
...
model_2022 <- lm(hdi ~ sqrt_broadband, data=data_2022_standardized)
summary(model_2022)
```
...
# Question 3
How has broadband access by country changed between 2011, when the UN declaration was announced, and 2023? 
...
model_2011 <- lm(hdi ~ sqrt_broadband, data=data_2011_standardized)
summary(model_2011)
```
